...
window.BMAP_AUTHENTIC_KEY = "tl5iZ0wY3wQRi2zSnBhUAW5LUbTgWxNR";
(function () {
    function ca(a) {
        throw a;
    }
    ...
    z.nV = z.apiLoad || function () {
        if (z.version && z.version >= 1.5) {
            ...
            }, q) : a.attachEvent && a.attachEvent("onreadystatechange", function () {
    ...
    x.extend(Ma.prototype, {
        ...
        mk: function (a, b, c, d) {
            ...
            if (c = c && d ? f.Hk(c, this.Sb) : this.dc)
                if (this.dc = new I(c.lng + a * e, c.lat - b * e), (a = f.rh(this.dc, this.Sb)) && g) this.re = a
        },
        Hg: function (a, b) {
            if (Ya(a) && (this.cv(), this.dispatchEvent(new M("onzoomstart")), a = this.eo(a).zoom, a !== this.Na)) {
                this.Mc = this.Na;
                this.Na = a;
                var c;
                b ? c = new I(Za(cp, me).lng, Za(b, me).lat) : this.lh() && (c = this.lh().ia());
        ...
        yi: function (a) {
            if (a instanceof N || a instanceof I) a = Za(a, this), this.dc = this.Ld.Hk(a, this.Sb), this.re = I.DE(a) ? new I(a.lng, a.lat) : this.Ld.rh(this.dc, this.Sb)
        },
        yg: function (a, b) {
            a = Math.round(a) || 0;
            b = Math.round(b) || 0;
        ...
        gs: function (a) {
            a && $a(a.Ie) && (a.Ie(this), this.dispatchEvent(new M("onaddcontrol", a)))
        },
        SN: function (a) {
            a && $a(a.remove) && (a.remove(), this.dispatchEvent(new M("onremovecontrol", a)))
        },
        Eo: function (a) {
            a && $a(a.ra) && (a.ra(this), this.dispatchEvent(new M("onaddcontextmenu", a)))
        },
        Mp: function (a) {
            a && $a(a.remove) && (this.dispatchEvent(new M("onremovecontextmenu", a)), a.remove())
        },
        Ja: function (a) {
            a && $a(a.Ie) && (a.Ie(this), this.dispatchEvent(new M("onaddoverlay", a)))
        },
        Ub: function (a) {
            a && $a(a.remove) && (a.remove(), this.dispatchEvent(new M("onremoveoverlay", a)))
        },
        zK: function () {
        ...
        Wf: function (a) {
            var b = this;
            if (a instanceof N || a instanceof I) a = new I(Za(a, b).lng, Za(a, b).lat), b.yi(a, {
                noAnimation: o
            });
            else if (bb(a))
                if (b.xb === Qa) {
                    ...
                    var d = this.ZH();
                    d.MF(function (c) {
                        0 === d.Gm() && 2 === d.Ga.result.type && (b.Wf(c.Ck(0).point), Qa.yk(a) && b.GF(a))
                    });
                    d.search(a, {
                        log: "center"
                    })
        ...
        Kp: function (a, b) {
            b = b || this.ga();
            if (a && (a instanceof N || a instanceof I)) return a = Za(a, this), this.Ld.Kp(a, b, this.dc, this.vb(), this.Sb)
        },
        Rb: function (a, b) {
            b = b || this.ga();
        ...
        g4: function (a, b) {
            var c = this,
                d = map.Sb;
            c.xb === Qa && d && gb.FK(a, c, function (a) {
                a.x -= c.offsetX;
                a.y -= c.offsetY;
                b && b(a)
            })
        ...
        d4: function (a, b) {
            var c = map.Sb;
            this.xb === Qa && c && (a.x += this.offsetX, a.y += this.offsetY, gb.EK(a, this, b))
        },
        Id: function (a) {
        ...
        jt: function (a, b) {
            ...
            for (var b = b || {}, e = [], f = 0, g = d.length; f < g; f++) e.push(this.Ld.Hk(Za(d[f], this), this.Sb));
            d = new hb;
        ...
        Ix: function () {
            var a = [],
                ...
                c = this.Fe;
            if (b)
                for (var d in b) b[d] instanceof ib && a.push(b[d]);
            if (c) {
                d = 0;
        ...
        qM: function (a) {
            a ? this.ys && this.ys.Bf === a || (this.Ah(this.ys), this.ys = new pb({
                geotableId: a
    ...
    function Sa(a, b) {
        if (a) {
            ...
            var e = function (a) {
                    a && (qb = o, setTimeout(function () {
                        rb.src ="http://api.map.baidu.com/lbsapi/createmap/images/icon.png?"
                    }, 50))
                },
                f = function () {
                    var a = sb.shift();
    ...
    function xb(a) {
        var b = cb();
        b >= a.mA ? ($a(a.k.va) && a.k.va(a.k.hc(1)), $a(a.k.finish) && a.k.finish(), 0 < a.Zf.length && (b = a.Zf[0], b.Zf = [].concat(a.Zf.slice(1)), b.start())) : (a.Ky = a.k.hc((b - a.Uu) / a.k.duration), $a(a.k.va) && a.k.va(a.Ky), a.VF || (a.cs = setTimeout(function () {
            xb(a)
        }, 1E3 / a.k.Hc)))
    }
    ...
    x.da.Te ? (x.extend(G, {
        ...
        Xb: "-moz-grab",
        Gd: "-moz-grabbing"
    }), x.platform.DM && (G.fontFamily = "arial,simsun,sans-serif")) : x.da.Pw || x.da.yF ? x.extend(G, {
    ...
    function Lb(a) {
        ...
        do c = Kb.indexOf(a.charAt(i++)), d = Kb.indexOf(a.charAt(i++)), f = Kb.indexOf(a.charAt(i++)), g = Kb.indexOf(a.charAt(i++)), c = c << 2 | d >> 4, d = (d & 15) << 4 | f >> 2, e = (f & 3) << 6 | g, b += String.fromCharCode(c), 64 != f && (b += String.fromCharCode(d)), 64 != g && (b += String.fromCharCode(e)); while (i < a.length);
        return b
    }
    var M = x.lang.qz;
        ...
        function (a, b, c) {
            ...
            if (s && s.Bh && k() < s.Bh) {
                var A = ["Moz", "O", "ms", "Webkit"],
                    ...
                    Ge = function () {
                        return "Promise" in a && "cast" in a.tq && "resolve" in a.tq && "reject" in a.tq && "all" in a.tq && "race" in a.tq && function () {
                            var b;
                            new a.tq(function (a) {
                                b = a
                            });
    ...
    function sc(a) {
        ...
        for (;;) {
            ...
            if (1.0E-6 > f) {
                a: {
                    c = (a.lng + 0.03 - (a.lng - 0.03)) / 1.0E-4 + 0.5;f = (a.lat + 0.03 - (a.lat - 0.03)) / 1.0E-4 + 0.5;g = a.lng * pc;i = a.lat * pc;w = 1.0E-4 * pc;k = g - w;m = g + w;s = i - w;B = i + w;A = l = u = J = j;D = l = w = E = u = J = 0;b(a);A = j;
                    for (O = 0; O <= c; O++) {
                        for (d = 0; d <= f; d++)
                            if (A = b(j), J = j.lng * pc, u = j.lat * pc, l = A.lng * pc, A = A.lat * pc, !(l < k || A < s || l > m || A > B)) {
                                J -= l;
                                u -= A;
                    ...
                    b = E * pc / pc;f = w * pc / pc;c = {};c.lng = a.lng + b;c.lat = a.lat + f
                }
                return c
            }
        }
    ...
    yc.prototype.contains = function (a) {
        return a.lng > this.vg.lng && a.lng < this.Dg.lng && a.lat > this.vg.lat && a.lat < this.Dg.lat ? mc : Math.abs(a.lng - this.vg.lng) < nc || Math.abs(a.lng - this.Dg.lng) < nc || Math.abs(a.lat - this.vg.lat) < nc || Math.abs(a.y - this.Dg.lat) > nc ? 2 : lc
    };
    ...
    function tc(a) {
        ...
        for (var b = 0, c = kc, d = 0, e = new yc, f = 0, d = 0; d < $b; ++d) bc[d] <= a.lat ? bc[(d + 1) % $b] > a.lat && 0 < Bc({
            lng: ac[d],
            lat: bc[d]
        }, {
            lng: ac[(d + 1) % $b],
        ...
        if ((0 === f ? lc : mc) === lc) {
            for (f = 0; f < $b; ++f)
                if (d = new zc(ac[f], bc[f], ac[(f + 1) % $b], bc[(f + 1) % $b]), e.vg.lng = d.ky.vg.lng - 0.5, e.vg.lat = d.ky.vg.lat - 0.5, e.Dg.lng = d.ky.Dg.lng + 0.5, e.Dg.lat = d.ky.Dg.lat + 0.5, e.contains(a) !== lc) {
                    var g;
                    var i = d.mu.lng,
                        k = d.mu.lat,
                        l = d.qx.lng,
                    ...
                    g = m - k;
                    var n = i - l;
                    !(Math.abs(g - 0) > nc) && !(Math.abs(n - 0) > nc) ? g = d.mu: (i = l * k - i * m, k = n * a.lng - g * a.lat, l = g * g - n * n, g = {
                        lng: (n * k - g * i) / l,
                        lat: -(g * k + n * i) / l
                    });
                    n = 180;
                    ...
                    g.lng <= k && g.lng >= n && g.lng <= l && g.lat >= i ? (d = a.lat * hc, n = a.lng * hc, i = g.lat * hc, g = g.lng * hc, k = Math.cos(d) * Math.cos(i), d = k * Math.cos(n) * Math.cos(g) + k * Math.sin(n) * Math.sin(g) + Math.sin(d) * Math.sin(i), -1 > d ? d = -1 : 1 < d && (d = 1), d = Math.acos(d) * oc) : (g = Ac(a, d.mu), d = Ac(a, d.qx), d = g < d ? g : d);
                    d < c && (c = d)
                } c < kc && (b = (kc - c) / kc)
        } else b = 1;
        c = rc(a);
    ...
    function qa(a, b) {
        ...
        d.charset = "utf-8"; - 1 === pa && (window.__abbaidu_2063_cb = function (a) {
            pa = JSON.parse(a).data || p
        });
        d.src = a + "&seckey=" + pa;
    ...
    x.object.extend(K, {
                ...
                if (d.Cd == this.Jj.FG) {
                    ...
                    e.RC == q && (e.RC = o, setTimeout(function () {
                        for (var a = [], b = 0, c = e.Rd.Mn.length; b < c; b++) {
                            var d = e.Rd.Mn[b],
                                l = "";
                            ja.$y.vK(d) ? l = ja.$y.get(d) : (l = "", a.push(d + "_" + Dc[d]));
                            e.Rd.bw.push({
                                hN: d,
                                $E: l
                            })
        ...
        BK: function (a) {
            if (a && this.HL()[a])
                for (var a = this.HL()[a], b = 0; b < a.length; b++) this.BK(a[b]), this.Rd.Al[a[b]] || this.PN(a[b])
        },
        PN: function (a) {
            for (var b = 0; b < this.Rd.Mn.length; b++)
                if (this.Rd.Mn[b] == a) return;
            this.Rd.Mn.push(a)
        },
        QZ: function (a, b) {
            var c = this.kb(a);
        ...
        kb: function (a) {
            this.Rd.Al[a] || (this.Rd.Al[a] = {}, this.Rd.Al[a].Cd = this.Jj.FG, this.Rd.Al[a].Zu = []);
            return this.Rd.Al[a]
        },
        remove: function (a) {
            delete this.kb(a)
        ...
        MV: function (a, b) {
            for (var c = this.Rd.bw, d = o, e = 0, f = c.length; e < f; e++) "" == c[e].$E && (c[e].hN == a ? c[e].$E = b : d = q);
            d && this.mL()
        },
        mL: function () {
            for (var a = this.Rd.bw, b = 0, c = a.length; b < c; b++) this.QZ(a[b].hN, a[b].$E);
            this.Rd.bw.length = 0
        }
    });
    ...
    function kb(a, b) {
        a && (this.Kb = a, this.ba = "spot" + kb.ba++, b = b || {}, this.Xg = b.text || "", this.Iv = b.offsets ? b.offsets.slice(0) : [5, 5, 5, 5], this.KJ = b.userData || p, this.Uh = b.minZoom || p, this.Gf = b.maxZoom || p)
    }
    kb.ba = 0;
    ...
    x.extend(Ec.prototype, {
        ...
        qc: function (a) {
            if (this.M1 || !Ya(a) || isNaN(a) || a < Fc || 3 < a) a = this.defaultAnchor;
            this.k = this.k || {
                Cg: q
            };
    ...
    x.object.extend(Pc.prototype, {
        ...
        tF: function (a) {
            if (this.Ge[a]) {
                for (var b = 0, c = this.ya.length; b < c; b++) this.ya[b] && ("divider" == this.ya[b].Lb && this.ya[b].Sj == a) && (this.ya.splice(b, 1), c--), this.ya[b] && ("divider" == this.ya[b].Lb && this.ya[b].Sj > a) && this.ya[b].Sj--;
                this.Ge.splice(a, 1)
            }
        },
        Jd: v("C"),
    ...
    x.object.extend(hb.prototype, {
        ...
        pf: v("Dl"),
        $V: function (a) {
            return !(a instanceof hb) || this.Bj() || a.Bj() ? q : a.Ne > this.Ne && a.Je < this.Je && a.Zd > this.Zd && a.Xd < this.Xd
        },
        pc: function () {
            return this.Bj() ? p : new N((this.Ne + this.Je) / 2, (this.Zd + this.Xd) / 2)
        },
        xt: function (a) {
            if (!(a instanceof hb) || Math.max(a.Ne, a.Je) < Math.min(this.Ne, this.Je) || Math.min(a.Ne, a.Je) > Math.max(this.Ne, this.Je) || Math.max(a.Zd, a.Xd) < Math.min(this.Zd, this.Xd) || Math.min(a.Zd, a.Xd) > Math.max(this.Zd, this.Xd)) return p;
        ...
        Vw: function (a) {
            return !(a instanceof N || a instanceof I) || this.Bj() ? q : a.lng >= this.Ne && a.lng <= this.Je && a.lat >= this.Zd && a.lat <= this.Xd
        },
        extend: function (a) {
    ...
    U(Wc.prototype, {
        translate: Wc.prototype.translate
    });
    ...
    x.extend(T, {
        ...
        tb: function (a) {
            if (a === p || a === j || 180 < a.lng || -180 > a.lng || 90 < a.lat || -90 > a.lat) return new I(0, 0);
            var b, c;
            a.lng = this.cE(a.lng, -180, 180);
            a.lat = this.gE(a.lat, -74, 74);
            b = new I(a.lng, a.lat);
    ...
    x.extend(T.prototype, {
        ...
        Kp: function (a, b, c, d, e) {
            if (a) return a = this.Hk(a, e), b = this.yc(b), new S(Math.round((a.lng - c.lng) / b + d.width / 2), Math.round((c.lat - a.lat) / b + d.height / 2))
        },
        zg: function (a, b, c, d, e) {
            if (a) return b = this.yc(b), this.rh(new I(c.lng + b * (a.x - d.width / 2), c.lat - b * (a.y - d.height / 2)), e)
        },
        yc: function (a) {
    ...
    Zc.fF = [0.09, 0.0050, 1.0E-4, 1.0E-5];
    x.extend(Zc.prototype, {
        ...
        ve: v("ha"),
        tn: function (a, b) {
            b && this.ha[a] && (this.gf.length = 0, this.ha[a] = new I(b.lng, b.lat), this.Ih())
        },
    ...
    x.extend($c.prototype, {
        ...
        initialize: function (a) {
            this.map = a;
            this.Mj();
            this.V && x.M(this.V, H() ? "touchstart" : "mousedown", function (a) {
                na(a)
            });
            return this.V
        },
    ...
    function cd(a, b, c, d) {
        a && (this.Nv = {}, this.sL = d ? !!d : q, this.hd = [], this.Q_ = a instanceof bd ? a : p, this.YI = b === j ? o : !!(b.indexOf("%") + 1), this.ek = isNaN(parseFloat(b)) ? 1 : this.YI ? parseFloat(b) / 100 : parseFloat(b), this.ZI = !!(c.indexOf("%") + 1), this.repeat = c != j ? this.ZI ? parseFloat(c) / 100 : parseFloat(c) : 0)
    };
    ...
    Ma.prototype.Mb = function (a, b) {
        if (a instanceof dd && (b instanceof N || b instanceof I)) {
            ...
            c.Um ? c.Um.ta(b) : (c.Um = new V(b, {
                icon: new ad("http://api.map.baidu.com/lbsapi/createmap/images/icon.png", {
                    width: 1,
                    height: 1
                }),
                offset: new L(0, 0),
    ...
    x.extend(ed.prototype, {
        ...
        ta: function (a) {
            if ((a instanceof N || a instanceof I) && !this.Ex()) this.point = this.z.position = new I(a.lng, a.lat)
        },
        ad: da("content"),
        JF: function (a) {
    ...
    function jd(a, b) {
        var c = this;
        id() && (a === j && ca(Error("\u6ca1\u6709\u4f20\u5165points\u6570\u636e")), "[object Array]" !== Object.prototype.toString.call(a) && ca(Error("points\u6570\u636e\u4e0d\u662f\u6570\u7ec4")), b = b || {}, ib.apply(c, arguments), c.ea = {
            ha: a
        }, c.z = {
            shape: b.shape || gd,
            size: b.size || hd,
            ...
            qj: o
        }, this.wB = [], this.pe = [], K.load("pointcollection", function () {
    ...
    x.extend(V.prototype, {
        ...
        co: v("point"),
        ia: function () {
            return this.point instanceof N || this.point instanceof I ? this.map ? fb(this.point, this.map) : new N(this.point.lng, this.point.lat) : this.point
        },
        ta: function (a) {
    ...
    x.extend(td.prototype, {
        ...
        gy: function () {
            ...
            this.loaded || a.Vx();
            a.Uf();
            this.loaded || (this.loaded = o, K.load("tile", function () {
                a.nQ()
            }))
        },
        Vx: function () {
        ...
        Jm: function (a, b, c) {
            ...
            l = 0;
            for (d = a.childNodes.length; l < d; l++) w = a.childNodes[l], w.qr = q, this.Oe.push(w);
            if (l = this.Zm)
            ...
            for (d = this.Rc.length; l < d; l++) {
                ...
                for (m = this.Oe.length; w < m; w++)
                    if (n = this.Oe[w], n.id == k + "_" + b + "_" + A + "_" + i + "_" + f) {
                        n.qr = o;
                        this.Zm[n.id] = n;
                        break
                    }
            ...
            l = 0;
            for (d = this.Oe.length; l < d; l++) n = this.Oe[l], n.qr || this.Pe.push(n);
            this.zn = [];
            w = (e + c) * this.map.B.devicePixelRatio;
            l = 0;
            for (d = this.Rc.length; l < d; l++) A = this.Rc[l][0], i = this.Rc[l][1], s = A * e + g[0] - c / 2, u = (-1 - i) * e + g[1] - c / 2, y = k + "_" + b + "_" + A + "_" + i + "_" + f, m = this.Zm[y], n = p, m ? (n = m.style, n.left = s + "px", n.top = u + "px", m.af || this.zn.push([A, i, m])) : (0 < this.Pe.length ? (m = this.Pe.shift(), m.getContext("2d").clearRect(-c / 2, -c / 2, w, w), n = m.style) : (m = document.createElement("canvas"), n = m.style, n.position = "absolute", n.width = e + c + "px", n.height = e + c + "px", this.$x() && (n.WebkitTransform = "scale(1.001)"), m.setAttribute("width", w), m.setAttribute("height", w), a.appendChild(m)), m.id = y, n.left = s + "px", n.top = u + "px", -1 < y.indexOf("bg") && (s = "#F3F1EC", this.map.B.Jo && (s = this.map.B.Jo), n.background = s ? s : ""), this.zn.push([A, i, m])), m.style.visibility = "";
            l = 0;
        ...
        F_: function (a, b, c, d) {
            ...
            k && k.Hb ? (yb(k.Hb, b), d && (d = new S(a[0], a[1]), f = this.map.B.ze ? this.map.B.ze.style : "normal", d = c.getTilesUrl(d, a[2], f), k.loaded = q, wd(k, d)), k.loaded ? this.zf() : xd(k, function () {
                e.zf()
            })) : (k = this.hj[g]) && k.Hb ? (c.Pb.insertBefore(k.Hb, c.Pb.lastChild), this.wg[g] = k, yb(k.Hb, b), d && (d = new S(a[0], a[1]), f = this.map.B.ze ? this.map.B.ze.style : "normal", d = c.getTilesUrl(d, a[2], f), k.loaded = q, wd(k, d)), k.loaded ? this.zf() : xd(k, function () {
                e.zf()
            })) : (k = i * Math.pow(2, f.Bm() - a[2]), new I(a[0] * k, a[1] * k), d = new S(a[0], a[1]), f = this.map.B.ze ? this.map.B.ze.style : "normal", d = c.getTilesUrl(d, a[2], f), k = new yd(this, d, b, a, c), xd(k, function () {
                e.zf()
            }), k.ko(), this.wg[g] = k)
        },
        zf: function () {
        ...
        lE: function (a, b) {
            return this.map.oa() === Qa ? "TILE-" + b.ba + "-" + this.map.Qw + "-" + a[0] + "-" + a[1] + "-" + a[2] : "TILE-" + b.ba + "-" + a[0] + "-" + a[1] + "-" + a[2]
        },
        Sx: function (a) {
            var b = a.Hb;
        ...
        Kw: function (a, b) {
            for (var c = 0, d = 6 * Math.pow(2, b - 3), e = d / 2 - 1, f = -d / 2; a > e;) a -= d, c -= this.cB;
        ...
        Uf: function (a) {
            var b = this;
            if (b.map.oa() == Qa) K.load("coordtrans", function () {
                b.map.Sb || (b.map.Sb = Qa.yk(b.map.bh), b.map.Qw = Qa.DL(b.map.Sb));
                b.EI()
            }, o);
            else {
                if (a && a)
            ...
            for (var g = 0; g < c; g++) {
                ...
                if (i.Hw) {
                    ...
                    if (this.map.Wb()) {
                        ...
                        continue
                    } else k.style.display = "block", this.md.style.display = "none", this.map.dispatchEvent(new M("vectorchanged"), {
                        isvector: q
                    })
                }
                if (!i.rI && !(i.yp && !this.map.Wb() || i.BM && this.map.Wb())) {
                    ...
                    for (A in B) {
                        var E = B[A],
                            C = E.info;
                        (C[2] != f || C[2] == f && (n > C[0] || u <= C[0] || l > C[1] || e <= C[1])) && this.Sx(E)
                    }
                    ...
                    w = [];
                    for (d.$B = []; n < u; n++)
                        for (y = l; y < e; y++) w.push([n, y]), d.$B.push({
                            x: n,
                            y: y
                        });
        ...
        Ah: function (a) {
            ...
            if (a instanceof eb) b && a.Pm && (a.remove(), a.Pm = q);
                ...
                if (a.yp)
                    for (var b = 0, c = this.Gg.length; b < c; b++) a == this.Gg[b] && this.Gg.splice(b, 1);
                else {
                    b = 0;
                    ...
                    if (e.A_ == o) {
                        ...
                        e.getTilesUrl = function (b, d) {
                            var e = b.x,
                                ...
                                m = 1;
                            this.map.Tx() && (m = 2);
                            l = "customimage/tile?&x=" + e + "&y=" + k + "&z=" + d + "&udt=" + l + "&scale=" + m + "&ak=" + ra;
    ...
    yd.prototype.ko = function () {
        this.Hb.src = 0 < x.da.ma && 6 >= x.da.ma && this.HJ ? "http://api.map.baidu.com/lbsapi/createmap/images/icon.png" : "" !== this.src && this.Hb.src == this.src ? this.src + "&t = " + Date.now() : this.src
    };
    ...
    x.extend(ud.prototype, {
        ...
        getTilesUrl: function (a, b) {
            if (this.map.oa() !== ab && this.map.oa() !== Ta) var c = this.map.gb.Kw(a.x, b).ls;
            var d = "";
    ...
    var Ed = [z.url.proto + z.url.domain.TILES_YUN_HOST[0] + "/georender/gss", z.url.proto + z.url.domain.TILES_YUN_HOST[1] + "/georender/gss", z.url.proto + z.url.domain.TILES_YUN_HOST[2] + "/georender/gss", z.url.proto + z.url.domain.TILES_YUN_HOST[3] + "/georender/gss"],
        Fd = z.url.proto + z.url.domain.main_domain_nocdn.baidu + "/style/poi/rangestyle",
        Gd = 100;
    ...
    pb.prototype.getTilesUrl = function (a, b) {
        var c = a.x,
            d = a.y,
            e = this.nc,
            c = Ed[Math.abs(c + d) % Ed.length] + "/image?grids=" + c + "_" + d + "_" + b + "&q=" + e.gn + "&tags=" + e.cz + "&filter=" + e.filter + "&sortby=" + e.Yy + "&ak=" + this.nc.am + "&age=" + e.Ew + "&page_size=" + e.MN + "&format=" + e.V_;
    ...
    var Id = [z.url.proto + z.url.domain.TILE_BASE_URLS[0] + "/it/", z.url.proto + z.url.domain.TILE_BASE_URLS[1] + "/it/", z.url.proto + z.url.domain.TILE_BASE_URLS[2] + "/it/", z.url.proto + z.url.domain.TILE_BASE_URLS[3] + "/it/", z.url.proto + z.url.domain.TILE_BASE_URLS[4] + "/it/"],
        Jd = [z.url.proto + z.url.domain.TILE_ONLINE_URLS[0] + "/tile/", z.url.proto + z.url.domain.TILE_ONLINE_URLS[1] + "/tile/", z.url.proto + z.url.domain.TILE_ONLINE_URLS[2] + "/tile/", z.url.proto + z.url.domain.TILE_ONLINE_URLS[3] + "/tile/"],
        Kd = {
            dark: "dl",
            light: "ll",
            normal: "pl"
    ...
    Ld.getTilesUrl = function (a, b, c) {
        ...
        return (Jd[Math.abs(d + a) % Jd.length] + "?qt=vtile&x=" + (d + "").replace(/-/gi, "M") + "&y=" + (a + "").replace(/-/gi, "M") + "&z=" + b + "&styles=" + c + "&scaler=" + f + (6 == x.da.ma ? "&color_dep=32&colors=50" : "") + "&udt=" + e + "&from=jsapi2_0").replace(/-(\d+)/gi, "M$1")
    };
    var Na = new Hd("\u5730\u56fe", Ld, {
            tips: "\u663e\u793a\u666e\u901a\u5730\u56fe",
            maxZoom: 19
        ...
        Md = new ud;
    Md.HO = [z.url.proto + z.url.domain.TIlE_PERSPECT_URLS[0] + "/resource/mappic/", z.url.proto + z.url.domain.TIlE_PERSPECT_URLS[1] + "/resource/mappic/", z.url.proto + z.url.domain.TIlE_PERSPECT_URLS[2] + "/resource/mappic/", z.url.proto + z.url.domain.TIlE_PERSPECT_URLS[3] + "/resource/mappic/"];
    ...
    Nd.getTilesUrl = function (a, b) {
        var c = a.x,
            d = a.y;
        return (Id[Math.abs(c + d) % Id.length] + "u=x=" + c + ";y=" + d + ";z=" + b + ";v=009;type=sate&fm=46&udt=" + Ub("satellite")).replace(/-(\d+)/gi, "M$1")
    };
    var ab = new Hd("\u536b\u661f", Nd, {
            tips: "\u663e\u793a\u536b\u661f\u5f71\u50cf",
            minZoom: 4,
    ...
    Od.getTilesUrl = function (a, b) {
        ...
        return (Jd[Math.abs(c + d) % Jd.length] + "?qt=vtile&x=" + (c + "").replace(/-/gi, "M") + "&y=" + (d + "").replace(/-/gi, "M") + "&z=" + b + "&styles=sl" + (6 == x.da.ma ? "&color_dep=32&colors=50" : "") + "&udt=" + e).replace(/-(\d+)/gi, "M$1")
    };
    ...
    x.extend(db.prototype, {
        ...
        Xp: function (a) {
            this.k.Lk = "number" == typeof a && !isNaN(a) ? 1 > a ? db.mq : a > db.Jn ? db.mq : a : db.mq
        },
        qf: function () {
            return this.k.Lk
        },
    ...
    x.extend(ge.prototype, {
        ...
        Xp: function (a) {
            ...
            this.k.Lk = "number" !== typeof a ? ge.Jn : 1 <= a && a <= ge.Jn ? Math.round(a) : ge.Jn
        },
    ...
    function Pa(a, b) {
        ...
        this.Tg = [];
        this.Fr = [];
        "cvsRender" == this.hk || Oa() ? (this.$j = 90, this.ck = -90) : "cssRender" == this.hk && (this.$j = 45, this.ck = -45);
        this.Jr = q;
        var e = this;
        this.ko = function () {
            this.hk === "flashRender" ? K.load("panoramaflash", function () {
                e.Ti()
            }, o) : K.load("panorama", function () {
                e.Ab()
            }, o);
    ...
    x.extend(Pa.prototype, {
        ...
        Oc: function (a) {
            a != this.Kc && (a > xe && (a = xe), a < ye && (a = ye), a != this.Kc && (this.Kc = a), "cssRender" === this.hk && this.Nc(this.Ea))
        },
        KB: function () {
            if (this.D)
                for (var a = this.D.Ix(), b = 0; b < a.length; b++)(a[b] instanceof V || a[b] instanceof ed) && a[b].point && this.wa.push(a[b])
        },
        Ny: da("D"),
        cu: function (a) {
            this.Nf = a || "none"
        ...
        kr: function () {
            return Wa() && !H() && "javascript" !== this.k.panoramaRenderer ? "flashRender" : !H() && Ob() ? "cvsRender" : "cssRender"
        },
        Ja: function (a) {
            this.Ke[a.jd] = a
        },
        ...
        Fa: function () {
            ...
            if (a && c)
                if (a.ab(c)) b = this.P.Fa();
                    ...
                    b = {};
                    b.heading = Ce(a.lng - c.lng, a.lat - c.lat) || 0;
                    var a = b,
                        c = this.cp(),
                        d = this.bo();
    ...
    function Me() {
        ...
        return -1 < a.indexOf("Chrome") || -1 < a.indexOf("SAMSUNG-GT-I9508") ? o : Ne = q
    }
    var Ne;
    ...
    x.extend(Oc.prototype, {
        ca: function () {
            function a(a) {
                ...
                } else b.Ya = b.wl, b.Kb = b.xl, b.dispatchEvent(new M("onnoresult"))
            }
            var b = this.P,
                c = this;
    ...
    Nc.prototype.getTilesUrl = function (a, b) {
        var c = Nc.PG[(a.x + a.y) % Nc.PG.length] + "?udt=20150114&qt=tile&styles=pl&x=" + a.x + "&y=" + a.y + "&z=" + b;
    ...
    x.extend(Pe, {
        DW: function (a, b, c) {
            ...
            "position_changed" == a && (b.data = Pe.Wd.Dj(new S(b.data.mercatorX, b.data.mercatorY)));
            c.dispatchEvent(new M("on" + a), b)
        }
    });
    var Qe = Pe;
    U(Qe, {
        dispatchFlashEvent: Qe.DW
    });
    var Re = {
        GP: 50
    };
    ...
    x.extend(Re, {
        vp: function (a, b, c, d) {
            if (!b || !c || !c.lngLat || !c.panoInstance) d();
                ...
                this.po === j && (this.po = new Oc(p, {
                    of: "api"
                }));
                var e = this;
                this.po.sC(b, function (b) {
                    b ? e.po.tj(c.lngLat, Re.GP, function (b) {
                        if (b && b.id) {
                            var f = b.id,
                                k = b.wh,
                                b = b.xh,
        ...
        OL: function (a, b, c, d, e) {
            ...
            return (Re.Ou + "?qt=pr3d&fovy=75&quality=80&panoid={panoId}&heading={panoHeading}&pitch={panoPitch}&width={width}&height={height}").replace(/\{(.*?)\}/g, function (a, b) {
                return f[b]
            })
        }
    });
    var Se = document,
        ...
        Ve;
    a: {
        for (var We = ["t", "webkitT", "MozT", "msT", "OT"], Xe, Ye = 0, Ze = We.length; Ye < Ze; Ye++)
    ...
    var $e = Ve ? "-" + Ve.toLowerCase() + "-" : "",
        ...
        uf = window.requestAnimationFrame || window.webkitRequestAnimationFrame || window.mozRequestAnimationFrame || window.oRequestAnimationFrame || window.msRequestAnimationFrame || function (a) {
            return setTimeout(a, 1)
        },
        vf = window.cancelRequestAnimationFrame || window.g5 || window.webkitCancelRequestAnimationFrame || window.mozCancelRequestAnimationFrame || window.oCancelRequestAnimationFrame || window.msCancelRequestAnimationFrame || clearTimeout,
        wf = kf ? " translateZ(0)" : "";
    ...
    function xf(a, b) {
        ...
        c.options.$k ? c.Nb.style[bf] = "translate(" + c.x + "px," + c.y + "px)" + wf : c.Nb.style.cssText += ";position:absolute;top:" + c.y + "px;left:" + c.x + "px";
        c.options.Ei && (c.options.GD = o);
        c.refresh();
        c.ca( of , window);
        c.ca(pf);
        !lf && "none" != c.options.lP && (c.ca("DOMMouseScroll"), c.ca("mousewheel"));
    ...
    xf.prototype = {
        ...
        KQ: function () {
            !this.th && (!this.cl && !(this.dm || this.Ly == this.Nb.offsetWidth * this.scale && this.Sp == this.Nb.offsetHeight * this.scale)) && this.refresh()
        },
        Rv: function (a) {
            var b;
            this[a + "Scrollbar"] ? (this[a + "ScrollbarWrapper"] || (b = Se.createElement("div"), this.options.AF ? b.className = this.options.AF + a.toUpperCase() : b.style.cssText = "position:absolute;z-index:100;" + ("h" == a ? "height:7px;bottom:1px;left:2px;right:" + (this.Fi ? "7" : "2") + "px" : "width:7px;bottom:" + (this.qi ? "7" : "2") + "px;top:2px;right:1px"), b.style.cssText += ";pointer-events:none;" + $e + "transition-property:opacity;" + $e + "transition-duration:" + (this.options.XW ? "350ms" : "0") + ";overflow:hidden;opacity:" + (this.options.Rx ? "0" : "1"), this.En.appendChild(b), this[a + "ScrollbarWrapper"] = b, b = Se.createElement("div"), this.options.AF || (b.style.cssText = "position:absolute;z-index:100;background:rgba(0,0,0,0.5);border:1px solid rgba(255,255,255,0.9);" + $e + "background-clip:padding-box;" + $e + "box-sizing:border-box;" + ("h" == a ? "height:100%" : "width:100%") + ";" + $e + "border-radius:3px;border-radius:3px"), b.style.cssText += ";pointer-events:none;" + $e + "transition-property:" + $e + "transform;" + $e + "transition-timing-function:cubic-bezier(0.33,0.66,0.66,1);" + $e + "transition-duration:0;" + $e + "transform: translate(0,0)" + wf, this.options.Ei && (b.style.cssText += ";" + $e + "transition-timing-function:cubic-bezier(0.33,0.66,0.66,1)"), this[a + "ScrollbarWrapper"].appendChild(b), this[a + "ScrollbarIndicator"] = b), "h" == a ? (this.dM = this.eM.clientWidth, this.lY = Te.max(Te.round(this.dM * this.dM / this.Ly), 8), this.kY.style.width = this.lY + "px") : (this.cP = this.dP.clientHeight, this.t0 = Te.max(Te.round(this.cP * this.cP / this.Sp), 8), this.s0.style.height = this.t0 + "px"), this.EB(a, o)) : this[a + "ScrollbarWrapper"] && (mf && (this[a + "ScrollbarIndicator"].style[bf] = ""), this[a + "ScrollbarWrapper"].parentNode.removeChild(this[a + "ScrollbarWrapper"]), this[a + "ScrollbarWrapper"] = p, this[a + "ScrollbarIndicator"] = p)
        },
        DB: function () {
            var a = this;
            setTimeout(function () {
        ...
        Ir: function (a, b) {
            this.cl || (a = this.qp ? a : 0, b = this.Cn ? b : 0, this.options.$k ? this.Nb.style[bf] = "translate(" + a + "px," + b + "px) scale(" + this.scale + ")" + wf : (a = Te.round(a), b = Te.round(b), this.Nb.style.left = a + "px", this.Nb.style.top = b + "px"), this.x = a, this.y = b, this.EB("h"), this.EB("v"))
        },
        EB: function (a, b) {
            var c = "h" == a ? this.x : this.y;
            this[a + "Scrollbar"] && (c *= this[a + "ScrollbarProp"], 0 > c ? (this.options.GD || (c = this[a + "ScrollbarIndicatorSize"] + Te.round(3 * c), 8 > c && (c = 8), this[a + "ScrollbarIndicator"].style["h" == a ? "width" : "height"] = c + "px"), c = 0) : c > this[a + "ScrollbarMaxScroll"] && (this.options.GD ? c = this[a + "ScrollbarMaxScroll"] : (c = this[a + "ScrollbarIndicatorSize"] - Te.round(3 * (c - this[a + "ScrollbarMaxScroll"])), 8 > c && (c = 8), this[a + "ScrollbarIndicator"].style["h" == a ? "width" : "height"] = c + "px", c = this[a + "ScrollbarMaxScroll"] + (this[a + "ScrollbarIndicatorSize"] - c))), this[a + "ScrollbarWrapper"].style[gf] = "0", this[a + "ScrollbarWrapper"].style.opacity = b && this.options.Rx ? "0" : "1", this[a + "ScrollbarIndicator"].style[bf] = "translate(" + ("h" == a ? c + "px,0)" : "0," + c + "px)") + wf)
        },
        VQ: function (a) {
            ...
            if ("select" != b && "input" != b && "textarea" != b) return a.stopImmediatePropagation ? a.stopImmediatePropagation() : a.CZ = o, a.stopPropagation(), a.preventDefault(), this.sx = this.bC = p, q
        },
        $v: function (a) {
            ...
            if (this.enabled) {
                ...
                this.options.zoom && (lf && 1 < a.touches.length) && (d = Te.abs(a.touches[0].pageX - a.touches[1].pageX), c = Te.abs(a.touches[0].pageY - a.touches[1].pageY), this.a0 = Te.sqrt(d * d + c * c), this.vy = Te.abs(a.touches[0].pageX + a.touches[1].pageX - 2 * this.kG) / 2 - this.x, this.wy = Te.abs(a.touches[0].pageY + a.touches[1].pageY - 2 * this.lG) / 2 - this.y, this.options.Hp && this.options.Hp.call(this, a));
                if (this.options.ly && (this.options.$k ? (c = getComputedStyle(this.Nb, p)[bf].replace(/[^0-9\-.,]/g, "").split(","), d = +(c[12] || c[4]), c = +(c[13] || c[5])) : (d = +getComputedStyle(this.Nb, p).left.replace(/[^0-9-]/g, ""), c = +getComputedStyle(this.Nb, p).top.replace(/[^0-9-]/g, "")), d != this.x || c != this.y)) this.options.Ei ? this.$d(tf) : vf(this.jC), this.Ej = [], this.Ir(d, c), this.options.ty && this.options.ty.call(this);
                this.vw = this.x;
                this.ww = this.y;
                this.pu = this.x;
                this.qu = this.y;
        ...
        tT: function (a) {
            ...
            if (this.options.zoom && lf && 1 < a.touches.length) e = Te.abs(a.touches[0].pageX - a.touches[1].pageX), f = Te.abs(a.touches[0].pageY - a.touches[1].pageY), this.$_ = Te.sqrt(e * e + f * f), this.cl = o, b = 1 / this.a0 * this.$_ * this.scale, b < this.options.bl ? b = 0.5 * this.options.bl * Math.pow(2, b / this.options.bl) : b > this.options.iq && (b = 2 * this.options.iq * Math.pow(0.5, this.options.iq / b)), this.Bp = b / this.scale, e = this.vy - this.vy * this.Bp + this.x, f = this.wy - this.wy * this.Bp + this.y, this.Nb.style[bf] = "translate(" + e + "px," + f + "px) scale(" + b + ")" + wf, this.options.DN && this.options.DN.call(this, a);
            else {
                this.wh = b.pageX;
                this.xh = b.pageY;
        ...
        lv: function (a) {
            if (!(lf && 0 !== a.touches.length)) {
                ...
                if (b.cl) d = b.scale * b.Bp, d = Math.max(b.options.bl, d), d = Math.min(b.options.iq, d), b.Bp = d / b.scale, b.scale = d, b.x = b.vy - b.vy * b.Bp + b.x, b.y = b.wy - b.wy * b.Bp + b.y, b.Nb.style[df] = "200ms", b.Nb.style[bf] = "translate(" + b.x + "px," + b.y + "px) scale(" + b.scale + ")" + wf, b.cl = q, b.refresh(), b.options.Gp && b.options.Gp.call(b, a);
                else {
                    if (b.th) {
                        ...
                        f.Ca || g.Ca ? (c = Te.max(Te.max(f.time, g.time), 10), b.options.lu && (f = d - b.vw, g = e - b.ww, Te.abs(f) < b.options.Xy && Te.abs(g) < b.options.Xy ? b.scrollTo(b.vw, b.ww, 200) : (f = b.xJ(d, e), d = f.x, e = f.y, c = Te.max(f.time, c))), b.scrollTo(Te.round(d), Te.round(e), c)) : b.options.lu ? (f = d - b.vw, g = e - b.ww, Te.abs(f) < b.options.Xy && Te.abs(g) < b.options.Xy ? b.scrollTo(b.vw, b.ww, 200) : (f = b.xJ(b.x, b.y), (f.x != b.x || f.y != b.y) && b.scrollTo(f.x, f.y, f.time))) : b.ro(200)
                    } else {
                        if (lf)
                            if (b.WK && b.options.zoom) clearTimeout(b.WK), b.WK = p, b.options.Hp && b.options.Hp.call(b, a), b.zoom(b.wh, b.xh, 1 == b.scale ? b.options.FW : 1), b.options.Gp && setTimeout(function () {
                                b.options.Gp.call(b, a)
                            }, 200);
                            else if (this.options.Ox) {
                            for (d = c.target; 1 != d.nodeType;) d = d.parentNode;
                            e = d.tagName.toLowerCase();
                            "select" != e && "input" != e && "textarea" != e ? (e = Se.createEvent("MouseEvents"), e.initMouseEvent("click", o, o, a.view, 1, c.screenX, c.screenY, c.clientX, c.clientY, a.ctrlKey, a.altKey, a.shiftKey, a.metaKey, 0, p), e.RR = o, d.dispatchEvent(e)) : d.focus()
                        }
                        b.ro(400)
                    }
        ...
        ro: function (a) {
            ...
            if (b == this.x && c == this.y) {
                if (this.th && (this.th = q, this.options.ty && this.options.ty.call(this)), this.qi && this.options.Rx && ("webkit" == Ve && (this.eM.style[gf] = "300ms"), this.eM.style.opacity = "0"), this.Fi && this.options.Rx) "webkit" == Ve && (this.dP.style[gf] = "300ms"), this.dP.style.opacity = "0"
        ...
        YU: function (a) {
            ...
            if ("zoom" == b.options.lP) {
                if (d = b.scale * Math.pow(2, 1 / 3 * (d ? d / Math.abs(d) : 0)), d < b.options.bl && (d = b.options.bl), d > b.options.iq && (d = b.options.iq), d != b.scale) !b.iz && b.options.Hp && b.options.Hp.call(b, a), b.iz++, b.zoom(a.pageX, a.pageY, d, 400), setTimeout(function () {
                    b.iz--;
                    !b.iz && b.options.Gp && b.options.Gp.call(b, a)
                }, 400)
            } else c = b.x + c, d = b.y + d, 0 < c ? c = 0 : c < b.je && (c = b.je), d > b.sf ? d = b.sf : d < b.od && (d = b.od), 0 > b.od && b.scrollTo(c, d, 0)
        },
        UU: function (a) {
        ...
        QB: function () {
            var a = this,
                ...
                d = Date.now(),
                e, f, g;
            a.dm || (a.Ej.length ? (e = a.Ej.shift(), e.x == b && e.y == c && (e.time = 0), a.dm = o, a.th = o, a.options.Ei) ? (a.GJ(e.time), a.Ir(e.x, e.y), a.dm = q, e.time ? a.ca(tf) : a.ro(0)) : (g = function () {
                var i = Date.now(),
                    k;
                if (i >= d + e.time) {
                    a.Ir(e.x, e.y);
        ...
        xJ: function (a, b) {
            ...
            a = this.Ve[e];
            d = (d = Te.abs(a - this.Ve[this.MC])) ? 500 * (Te.abs(this.x - a) / d) : 0;
            this.MC = e;
            e = this.vf.length - 1;
            for (c = 0; c < e; c++)
                if (b >= this.vf[c]) {
            ...
            b = this.vf[e];
            c = (c = Te.abs(b - this.vf[this.NC])) ? 500 * (Te.abs(this.y - b) / c) : 0;
            this.NC = e;
        ...
        refresh: function () {
            ...
            if ("string" == typeof this.options.lu) {
                ...
                a = 0;
                for (b = c.length; a < b; a++) d = this.ek(c[a]), d.left += this.kG, d.top += this.lG, this.Ve[a] = d.left < this.je ? this.je : d.left * this.scale, this.vf[a] = d.top < this.od ? this.od : d.top * this.scale
        ...
        scrollTo: function (a, b, c, d) {
            ...
            a = 0;
            for (b = e.length; a < b; a++) e[a].EZ && (e[a].x = this.x - e[a].x, e[a].y = this.y - e[a].y), this.Ej.push({
                x: e[a].x,
                y: e[a].y,
                time: e[a].time || 0
            });
        ...
        zoom: function (a, b, c, d) {
            var e = c / this.scale;
            this.options.$k && (this.cl = o, d = d === j ? 200 : d, a = a - this.kG - this.x, b = b - this.lG - this.y, this.x = a - a * e + this.x, this.y = b - b * e + this.y, this.scale = c, this.refresh(), this.x = 0 < this.x ? 0 : this.x < this.je ? this.je : this.x, this.y = this.y > this.sf ? this.sf : this.y < this.od ? this.od : this.y, this.Nb.style[df] = d + "ms", this.Nb.style[bf] = "translate(" + this.x + "px," + this.y + "px) scale(" + c + ")" + wf, this.cl = q)
        }
    };
    ...
    z.an(function (a) {
        ...
        a.addEventListener("position_changed", function () {
            a.k.visible && a.k.albumsControl === o && (b ? b.Fy(a.Yb()) : (b = new yf(a.k.albumsControlOptions), b.ra(a)))
        });
        a.addEventListener("albums_visible_changed", function () {
            a.k.albumsControl === o ? (b ? b.Fy(a.Yb()) : (b = new yf(a.k.albumsControlOptions), b.ra(a)), b.show()) : b.U()
        });
    ...
    x.extend(yf.prototype, {
        ...
        Fy: function (a, b) {
            if (b || !this.fk[this.Xc] || !(this.fk[this.Xc].panoId == a && 3 !== this.fk[this.Xc].recoType)) {
                var c = this,
                    d = this.UH(a);
                !b && -1 !== d && this.fk[d] && 3 !== this.fk[d].recoType ? this.Wp(d) : this.RX(function (a) {
                    for (var b = {}, d, i, k = q, l = [], m = 0, n = a.length; m < n; m++) d = a[m].catlog, i = a[m].floor, j !== d && ("" === d && j !== i ? (k = o, b[i] || (b[i] = []), b[i].push(a[m])) : (b[Af[d]] || (b[Af[d]] = []), b[Af[d]].push(a[m])));
        ...
        hW: function () {
            if (this.Oi) a = this.CL(this.Ri), this.JQ.innerHTML = a;
                ...
                var a = F("div"),
                    ...
                    f = F("a"),
                    g = F("span"),
                    i = ["background:url(" + G.qa + "panorama/catlog_icon.png) no-repeat;", "display:block;width:10px;height:7px;margin:0 auto;"].join("");
        ...
        Ml: function (a) {
            this.fk = a;
            this.k.showCatalog && (0 < this.Ri.length ? (Wa() ? this.hW() : this.kW(), this.Pc.offsetLeft = 60) : (this.Rs && (this.C.removeChild(this.Rs), this.Rs = p, this.Pc.fg.style.left = "0px"), this.Oi && (this.C.removeChild(this.Oi), this.Oi = p), this.Pc.offsetLeft = 0));
            var b = this.zX(a);
            Wa() && (this.Ri && 0 < this.Ri.length && this.k.showExit && this.nA) && (this.Pc.offsetLeft += this.eg.width + 8, this.Rs ? this.Rs.innerHTML = this.nA : this.iW());
            this.$h.innerHTML = b;
        ...
        zX: function (a) {
            for (var b, c, d, e, f = [], g = this.eg.height, i = this.eg.width, k = 0; k < a.length; k++) b = a[k], recoType = b.recoType, d = b.panoId, e = b.name, c = b.heading, b = b.pitch, c = Re.OL(d, c, b, 198, 108), b = '<a href="javascript:void(0);" class="pano_photo_item" data-index="' + k + '"><img style="width:' + (i - 2) + "px;height:" + (g - 2) + 'px;" data-index="' + k + '" name="' + e + '" src="' + c + '" alt="' + e + '"/><span class="pano_photo_decs" data-index="' + k + '" style="width:' + i + "px;font-size:" + Math.floor(g / 6) + "px; line-height:" + Math.floor(g / 6) + 'px;"><em class="pano_poi_' + recoType + '"></em>' + e + "</span></a>", 3 === recoType ? Wa() ? (this.nA = b, this.UW = d, a.splice(k, 1), k--) : (b = '<a href="javascript:void(0);" class="pano_photo_item" data-index="' + k + '"><img style="width:' + (i - 2) + "px;height:" + (g - 2) + 'px;" data-index="' + k + '" name="' + e + '" src="' + c + '" alt="' + e + '"/><div style="background:rgba(37,37,37,0.5);position:absolute;top:0px;left:0px;width:100%;height:100%;text-align: center;line-height:' + this.k.imageHeight + 'px;" data-index="' + k + '"><img src="' + G.qa + 'panorama/photoexit.png" style="border:none;vertical-align:middle;" data-index="' + k + '" alt=""/></div></a>', f.push(b)) : f.push(b);
            return f.join("")
        },
        RX: function (a) {
            var b = this,
                c = this.P.Yb();
            c && this.Ql.Lx(c, function (d) {
                b.P.Yb() === c && a(d)
            })
        },
        qc: function (a) {
        ...
        rQ: function () {
            ...
            x.M(this.kk, "click", function (b) {
                if ((b = (b.srcElement || b.target).getAttribute("data-index")) && b != a.Xc) a.Wp(b), a.P.rc(a.fk[b].panoId)
            });
    ...
    U(Zf, {
        getMapType: Zf.oa,
        getCopyright: Zf.ym,
        isTransparentPng: Zf.Dt
    });
    var $f = Pc.prototype;
    U($f, {
        addItem: $f.Bw,
        addSeparator: $f.fC,
        removeSeparator: $f.tF
    });
    var ag = Sc.prototype;
    U(ag, {
        setText: ag.eu
    ...
    U(he, {
        setPolicy: he.du,
        toString: he.toString,
        setPageCapacity: he.Xp
    });
    U(window, {
